...
graph TD
    %% Node Definitions
    Root(("Root\n(Genesis)"))
    Idea1("Context Block A\n(User Segment)")
    Idea2("Context Block B\n(User Segment)")
    
    Reason1["Reasoning Node\n(Analysis)"]
    Fact1["Fact Node\n(Extracted Entity)"]
    ...
    %% Styling
    style Root fill:#339af0,stroke:#white,color:white
    style Reason1 fill:#fab005,stroke:#white,color:white
    style Fact1 fill:#40c057,stroke:#white,color:white
```
